...
contract PeanutV4RouterTest is Test {
    ...
    function testWithdrawETHAndBridge(
        ...
        uint256 depositIndex = peanutV4.makeDeposit{value: amountDeposited}(address(0), 0, amountDeposited, 0, SAMPLE_ADDRESS);
    ...
    function testWithdrawFee(
        ...
        vm.expectRevert(abi.encodeWithSelector(Ownable.OwnableUnauthorizedAccount.selector, SAMPLE_ADDRESS));
