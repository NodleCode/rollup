...
| **SwarmRegistryL1**        | Tag group registry (L1)        | `keccak256(fleetUuid, providerId, filter)` | —     |
| **SwarmRegistryUniversal** | Tag group registry (ZkSync+)   | `keccak256(fleetUuid, providerId, filter)` | —     |
